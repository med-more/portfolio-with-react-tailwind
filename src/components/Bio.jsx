    ...
    <section id="bio" className="py-20 w-full">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-4xl font-bold bg-gradient-to-r from-white to-blue-300 bg-clip-text text-transparent">
            My Story
          </h2>
        </motion.div>
            ...
            <div className="relative z-10 backdrop-blur-xl bg-black/30 border-l-2 border-t-2 border-white/10 p-8 md:p-12">
              ...
              >
                <motion.a
                  ...
                  className="inline-flex items-center gap-2 rounded-none bg-blue-500/20 px-8 py-4 text-base font-medium text-white backdrop-blur-sm transition-all hover:bg-blue-500/30 border-l-2 border-t-2 border-blue-500/30"
                >
