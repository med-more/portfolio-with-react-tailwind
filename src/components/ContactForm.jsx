      ...
      <div className="mb-4 flex flex-col lg:flex-row space-x-0 lg:space-x-4">
        <div className="lg:w-1/2">
          ...
          {errors.name && (
            ...
            initial={{opacity:0}}
            whileInView={{opacity:1}}
             className="text-sm text-rose-500">{errors.name}</motion.p>
          )}
        </div>
        <div className="lg:w-1/2">
          ...
          {errors.email && (
            ...
            initial={{opacity:0}}
            whileInView={{opacity:1}}
             className="text-sm text-rose-500">{errors.email}</motion.p>
          )}
        </div>
      </div>
      <div className="mb-4">
        ...
        {errors.message && (
          ...
          initial={{opacity:0}}
          whileInView={{opacity:1}}
           className="text-sm text-rose-500">{errors.message}</motion.p>
        )}
      </div>
