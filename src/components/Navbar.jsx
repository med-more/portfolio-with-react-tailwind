...
const Navbar = () => {
  ...
  // Update the toggleTheme function to properly save and apply the theme
  const toggleTheme = () => {
      ...
      >
        <div className="flex w-full items-center justify-between">
          <motion.a
            ...
            className="text-3xl font-bold bg-gradient-to-r from-white to-blue-300 bg-clip-text text-transparent transition-colors hover:from-blue-300 hover:to-white drop-shadow-[0_2px_10px_rgba(59,130,246,0.3)]"
          >
            MedFolio
          </motion.a>
      ...
      >
        <div className="flex items-center justify-between p-4">
          <motion.a
            ...
            href="#hero"
            onClick={(e) => handleLinkClick(e, "#hero")}
            className="text-2xl font-bold bg-gradient-to-r from-white to-blue-300 bg-clip-text text-transparent transition-colors hover:from-blue-300 hover:to-white drop-shadow-[0_2px_10px_rgba(59,130,246,0.3)]"
          >
            MedFolio
          </motion.a>
